 ...
 *  more specifically from the streaming/src/java/org/apache/hive/streaming/AbstractRecordWriter.java file.
...
public abstract class AbstractRecordWriterFixed implements RecordWriter {
    private static final Logger LOG = LoggerFactory.getLogger(AbstractRecordWriterFixed.class.getName());
    ...
    public AbstractRecordWriterFixed(final String lineDelimiter) {
    ...
    protected void prepareBucketingFields() {
        ...
        // For unbucketed tables we have exactly 1 RecordUpdater (until HIVE-19208) for each AbstractRecordWriterFixed which
