...
import static org.apache.nifi.processors.hive.PutHive3StreamingFixed.HIVE_STREAMING_RECORD_COUNT_ATTR;
import static org.apache.nifi.processors.hive.PutHive3StreamingFixed.KERBEROS_CREDENTIALS_SERVICE;
...
/**
 * Unit tests for PutHive3StreamingFixed processor.
 */
public class TestPutHive3StreamingFixed {
    ...
    private MockPutHive3StreamingFixed processor;
    ...
    public void setUp() throws Exception {
        ...
        ugi = null;
        processor = new MockPutHive3StreamingFixed();
    ...
    private void configure(final PutHive3StreamingFixed processor, final int numUsers) throws InitializationException {
        configure(processor, numUsers, -1);
    }

    private void configure(final PutHive3StreamingFixed processor, final int numUsers, int failAfter) throws InitializationException {
        configure(processor, numUsers, failAfter, null);
    }

    private void configure(final PutHive3StreamingFixed processor, final int numUsers, final int failAfter,
                           final BiFunction<Integer, MockRecordParser, Void> recordGenerator) throws InitializationException {
        runner = TestRunners.newTestRunner(processor);
        runner.setProperty(PutHive3StreamingFixed.HIVE_CONFIGURATION_RESOURCES, TEST_CONF_PATH);
        ...
        runner.setProperty(PutHive3StreamingFixed.RECORD_READER, "mock-reader-factory");
    }

    private void configureComplex(final MockPutHive3StreamingFixed processor, final int numUsers, final int failAfter,
    ...
    public void testSetup() throws Exception {
        ...
        runner.setProperty(PutHive3StreamingFixed.METASTORE_URI, "thrift://localhost:9083");
        runner.setProperty(PutHive3StreamingFixed.DB_NAME, "default");
        runner.assertNotValid();
        runner.setProperty(PutHive3StreamingFixed.TABLE_NAME, "users");
        runner.assertValid();
        runner.run();
    }
    ...
    public void testSetupWithKerberosAuthFailed() throws Exception {
        ...
        runner.setProperty(PutHive3StreamingFixed.DB_NAME, "default");
        runner.setProperty(PutHive3StreamingFixed.TABLE_NAME, "users");
        runner.setProperty(PutHive3StreamingFixed.HIVE_CONFIGURATION_RESOURCES, "src/test/resources/core-site-security.xml, src/test/resources/hive-site-security.xml");
    ...
    public void onTrigger() throws Exception {
        ...
        runner.assertTransferCount(PutHive3StreamingFixed.REL_SUCCESS, 1);
        final MockFlowFile flowFile = runner.getFlowFilesForRelationship(PutHive3StreamingFixed.REL_SUCCESS).get(0);
    ...
    public void onTriggerBadInput() throws Exception {
        ...
        runner.assertTransferCount(PutHive3StreamingFixed.REL_FAILURE, 1);
    }
    ...
    public void onTriggerBadInputRollbackOnFailure() throws Exception {
        ...
        runner.setProperty(PutHive3StreamingFixed.ROLLBACK_ON_FAILURE, "true");
        runner.enqueue("I am not an Avro record".getBytes());
        try {
            runner.run();
        ...
        runner.assertTransferCount(PutHive3StreamingFixed.REL_FAILURE, 0);
    ...
    public void onTriggerMultipleRecordsSingleTransaction() throws Exception {
        ...
        runner.assertTransferCount(PutHive3StreamingFixed.REL_SUCCESS, 1);
        MockFlowFile resultFlowFile = runner.getFlowFilesForRelationship(PutHive3StreamingFixed.REL_SUCCESS).get(0);
    ...
    public void onTriggerMultipleRecordsFailInMiddle() throws Exception {
        ...
        runner.assertTransferCount(PutHive3StreamingFixed.REL_SUCCESS, 0);
        runner.assertTransferCount(PutHive3StreamingFixed.REL_FAILURE, 1);
        runner.assertTransferCount(PutHive3StreamingFixed.REL_RETRY, 0);
    }
    ...
    private void assertOutputAvroRecords(List<Map<String, Object>> expectedRecords, MockFlowFile resultFlowFile) throws IOException {
        assertEquals(String.valueOf(expectedRecords.size()), resultFlowFile.getAttribute(PutHive3StreamingFixed.HIVE_STREAMING_RECORD_COUNT_ATTR));
    ...
    public void onTriggerWithWriteFailure() throws Exception {
        ...
        runner.assertTransferCount(PutHive3StreamingFixed.REL_FAILURE, 1);
        final MockFlowFile flowFile = runner.getFlowFilesForRelationship(PutHive3StreamingFixed.REL_FAILURE).get(0);
    ...
    public void onTriggerWithCommitFailure() throws Exception {
        ...
        runner.setProperty(PutHive3StreamingFixed.DB_NAME, "default");
        runner.setProperty(PutHive3StreamingFixed.TABLE_NAME, "users");
        runner.setProperty(PutHive3StreamingFixed.ROLLBACK_ON_FAILURE, "false");
        runner.enqueue(new byte[0]);
        runner.run();

        runner.assertTransferCount(PutHive3StreamingFixed.REL_FAILURE, 0);
        runner.assertTransferCount(PutHive3StreamingFixed.REL_SUCCESS, 0);
        runner.assertTransferCount(PutHive3StreamingFixed.REL_RETRY, 1);
    }
    ...
    private class MockPutHive3StreamingFixed extends PutHive3StreamingFixed {
        ...
        StreamingConnection makeStreamingConnection(HiveOptions options, RecordReader reader) throws StreamingException {
            ...
            HiveRecordWriterFixed hiveRecordWriter = new HiveRecordWriterFixed(reader, getLogger());
