 ...
 *  nifi-nar-bundles/nifi-hive-bundle/nifi-hive3-processors/src/main/java/org/apache/hive/streaming/HiveRecordWriter.java file.
 ...
 */
public class HiveRecordWriterFixed extends AbstractRecordWriterFixed {
/* --- CHANGED --- */
    ...
    public HiveRecordWriterFixed(RecordReader recordReader, ComponentLog log) {
        super(null);
